...
import 'package:flutter_basics/topics/assignment_m19_project_api/services/home_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeScreen(), // date 3 march 2026 - module 19 assignment - basic api project
    );
  }
}